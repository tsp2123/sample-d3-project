...
module.exports = "sample-d3-project/countries.21c9b83d.csv";
...
function ready(datapoints) {
  ...
  svg.selectAll('circle').data(datapoints).enter().append('circle').attr('r', 4).attr('cx', function (d) {
    ...
    d3.select(nodes[i]).attr('fill', colorScale(d.continent));
...
},{"d3":"../node_modules/d3/index.js","./countries.csv":"countries.csv"}],"../../../../.npm-global/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=sample-d3-project/graph.1d00accb.map